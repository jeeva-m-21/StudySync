...
class AudioRecorder:
    def __init__(self, username):
        ...
        self.previous_recordings_label = tk.Label(self.root, text="Previous Recordings:")
        self.previous_recordings_label.pack(pady=5)

        self.recordings_listbox = Listbox(self.root, width=50)
    ...
    def play_audio_file(self, file_path):
        ...
        stream = audio.open(format=pyaudio.paInt16,  # Match the format used during recording
