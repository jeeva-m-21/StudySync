...
class PDFStorageApp:
    def __init__(self, root, username):
        ...
        # Title Label
        title_label = tk.Label(root, text="Drag & Drop PDFs or Browse to Add", font=("Helvetica", 16, "bold"), bg="#f0f4f7", fg="#333333")
        title_label.pack(pady=10)

        # PDF Listbox
        self.pdf_listbox = tk.Listbox(root, width=50, height=10, font=("Helvetica", 12), bg="#ffffff", fg="#333333", selectbackground="#4a90e2")
        self.pdf_listbox.pack(pady=10)

        # Browse Button
        tk.Button(root, text="Browse Files", command=self.browse_file, bg="#4a90e2", fg="#ffffff", font=("Helvetica", 12, "bold"), activebackground="#3a7ad9").pack(pady=5)

        # View Button
        tk.Button(root, text="View Files", command=self.load_pdf_titles, bg="#4a90e2", fg="#ffffff", font=("Helvetica", 12, "bold"), activebackground="#3a7ad9").pack(pady=5)
